...
// =========================================================================================
	...
	for (int t=0; t<Nt; t++)
	{
		...
		{
			double Value = 0;
			if (SumOfCell) Value = zai2[t][i].Prop();
			else  Value = zai3[t][WantedCell][i].Prop();

			if (t==0)
			{
				if (Value>=CutOff)	HasToBePrint.push_back(true);
				else			HasToBePrint.push_back(false);
			}
			else
			{
...
// =========================================================================================
	...
	for(int i=0; i<Ni; i++)
	{
		if (HasToBePrint[i])
		{
			if (SumOfCell)
			{
				Output<<zai2[0][i].Z()<<" "<<zai2[0][i].A()<<" "<<zai2[0][i].I()<<" ";
			...
			{
				Output<<zai3[0][0][i].Z()<<" "<<zai3[0][0][i].A()<<" "<<zai3[0][0][i].I()<<" ";
				for (int t=StepToSkip; t<vTime.size(); t++)
				{
	...
	for(int i=0; i< (int)zai_FS_3[0][0].size(); i++)
	{
		...
		if (HasToBePrint[i])
		{
			if (SumOfCell)
			{
				...
				Output<<zai_FS_2[0][i].Z()<<" "<<zai_FS_2[0][i].A()<<" "<<zai_FS_2[0][i].I()<<" ";
				for (int t=StepToSkip; t<vTime.size(); t++)
				{
			...
			else
			{
				...
				Output<<zai_FS_3[0][0][i].Z()<<" "<<zai_FS_3[0][0][i].A()<<" "<<zai_FS_3[0][0][i].I()<<" ";
				for (int t=StepToSkip; t<vTime.size(); t++)
				{
	...
	for(int i=0; i < (int)zai_SC_3[0][0].size(); i++)
	{
		if (HasToBePrint[i])
		{
			if (SumOfCell)
			{
				Output<<zai_SC_2[0][i].Z()<<" "<<zai_SC_2[0][i].A()<<" "<<zai_SC_2[0][i].I()<<" ";
				for (int t=StepToSkip; t<vTime.size(); t++)
				{
			...
			{
				Output<<zai_SC_3[0][0][i].Z()<<" "<<zai_SC_3[0][0][i].A()<<" "<<zai_SC_3[0][0][i].I()<<" ";
				for (int t=StepToSkip; t<vTime.size(); t++)
				{
	...
	for(int i=0; i<  (int)zai_SN_3[0][0].size(); i++)
	{
		if (HasToBePrint[i])
		{
			if (SumOfCell)
			{
				Output<<zai_SN_2[0][i].Z()<<" "<<zai_SN_2[0][i].A()<<" "<<zai_SN_2[0][i].I()<<" ";
				for (int t=StepToSkip; t<vTime.size(); t++)
				{
			...
			{
				Output<<zai_SN_3[0][0][i].Z()<<" "<<zai_SN_3[0][0][i].A()<<" "<<zai_SN_3[0][0][i].I()<<" ";
				for (int t=StepToSkip; t<vTime.size(); t++)
				{
