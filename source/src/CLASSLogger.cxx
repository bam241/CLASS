...
//
//________________________________________________________________________
CLASSLogger::CLASSLogger(string CLASSLoggerName, int VerboseLvl,
                         int OutputLvl) {
  fCLASSLoggerName = CLASSLoggerName;
  fOutPutFile.open(CLASSLoggerName.c_str());
  fVerboseLVL = VerboseLvl;
  if (!fOutPutFile) {
    cout << "Could not open the CLASSLogger: " << CLASSLoggerName << " !"
         << endl;
    exit(-1);
  }
...
//________________________________________________________________________
CLASSLogger::~CLASSLogger() { fOutPutFile.close(); }
