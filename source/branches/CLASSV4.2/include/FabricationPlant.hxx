...
#endif
	void SortArray(vector <IsotopicVector>  StreamArray, vector <cSecond>  StreamArrayTime, vector < pair<int,int> >  StreamArrayAdress); //!< Sort IsotopicVector array according priority preferences (e.g first in first out)
